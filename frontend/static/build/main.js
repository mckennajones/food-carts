...
var Sidebar = __webpack_require__(19);
...
function format_html_marker(props) {
  ...
  var html = '<div class="marker-title">' + name + '</div>' + '<h4>Address</h4>' + '<span>' + address + '</span>' + '<h4>Rating</h4>' + convertRatingToHTML(rating) + '<h4>More Information</h4>' + '<span>' + '<a href="' + url + '">Website</a>' + '</span>';
...
var aa = __webpack_require__(1),
    ...
    r = __webpack_require__(5);function ba(a, b, c, d, e, f, g, h) {
  if (!a) {
    a = void 0;if (void 0 === b) a = Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else {
      var l = [c, d, e, f, g, h],
...
var Sidebar = function (_React$Component) {
  ...
  function Sidebar(props) {
    ...
    _this.plotOnMap = function () {
      var map = _this.props.map;
      var results = _this.state.results;

      _this.markers = [].concat.apply([], results.carts.map(function (c) {
        return {
          name: c.name,
          address: c.address,
    ...
    _this.handleHover = function (vendor) {
      ...
      var highlightMarkers = _this.markers.filter(function (m) {
        return m.name.toLowerCase() === vendor.toString().toLowerCase();
      });
      var usualMarkers = _this.markers.filter(function (m) {
        return m.name.toLowerCase() !== vendor.toString().toLowerCase();
      });

      var usualgeoJSON = _this.build_geojson(usualMarkers);
      var highlightgeoJSON = _this.build_geojson(highlightMarkers);
  ...
  _createClass(Sidebar, [{
    ...
    value: function render() {
      ...
      var renderedResults = results.map(function (r, i) {
        return React.createElement(Vendor, { key: i, data: r, handleHover: _this2.handleHover, onClick: _this2.selectVendor.bind(r.name) });
      });
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('input', { type: 'search', value: query, onChange: this.onChange,
              placeholder: 'What do you want to eat?', autoFocus: 'autofocus' }),
            React.createElement(
              'button',
              null,
              ' ',
              React.createElement('img', { src: 'assets/search.svg' })
            )
          )
        ),
...
var Vendor = function (_React$Component) {
  ...
  _createClass(Vendor, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        "li",
        { onClick: this.props.onClick.bind(null, r.name), onMouseEnter: this.props.handleHover.bind(null, r.name) },
        React.createElement(
          "p",
          { className: "cart-name" },
          r.name
        ...
        React.createElement(
          "div",
          { className: "row" },
          React.createElement("img", { src: "assets/pin.svg" }),
          React.createElement(
            "div",
            { className: "content" },
            r.address
        ...
        React.createElement(
          "div",
          { className: "row" },
          React.createElement("img", { src: "assets/information.svg" }),
          React.createElement(
            "div",
            { className: "content" },
            React.createElement(
